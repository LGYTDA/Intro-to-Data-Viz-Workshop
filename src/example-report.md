...
The history of rocket launches dates back to ancient China, where<span style="background: coral; padding: 0 4px;">gunpowder-filled tubes</span> were used as primitive forms of propulsion.
...
Private companies like <span class="essential"> Blue Origin</span>, founded by Jeff Bezos in 2000, and <span class="essential"> SpaceX</span>, founded by Elon Musk in 2002, entered the scene. These companies focused on developing reusable rocket technologies, significantly reducing launch costs.
